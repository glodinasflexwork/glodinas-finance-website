    ...
    <nav className="bg-white shadow-md">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden md:ml-6 md:flex md:space-x-8">
              ...
              <Link href="/getting-started" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                Getting Started
              </Link>
            </div>
          </div>
      ...
      <div className="hidden md:hidden">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/getting-started" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800">
            Getting Started
          </Link>
        </div>
        <div className="pt-4 pb-3 border-t border-gray-200">
          <div className="flex items-center px-4">
            <div className="ml-3">
              <div className="text-base font-medium text-gray-800">Need Help?</div>
              <div className="text-sm font-medium text-gray-500">Contact us for assistance</div>
            </div>
          </div>
          <div className="mt-3 space-y-1">
            <Link href="/contact" className="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
              Request a Consultation
            </Link>
          </div>
        </div>
